  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'בעריכת אירוע, בחרו DJ מרשימת התקליטנים הזמינים. המערכת תשלח אוטומטית הודעה ל-DJ עם פרטי האירוע (לפי תבנית DJ_ASSIGNED, בווטסאפ או בלוג לפי מצב השליחה), ותוודא שאין התנגשויות בלוח הזמנים.'
      },
      {
    ...
    items: [
      {
        ...
        a: '• **טיפול בהצעת מחיר** — כשלקוח ממלא את טופס ההזמנה, נוצרת משימה להכין ולשלוח הצעת מחיר על בסיס הפרטים שמילא.\n• **ליד כפול** — כשהמערכת מזהה כפילויות (אותו טלפון + תאריך).\n• **DJ חסר** — כשאירוע קרוב ואין DJ משובץ.'
      },
      {
    ...
    items: [
      {
        ...
        a: '**אוטומציות לפי אירוע (טריגר):**\n• ליד חדש → שליחת הודעת ווטסאפ ללקוח + משימת טיפול בהצעת מחיר.\n• שיבוץ DJ → הודעה ל-DJ עם פרטי האירוע.\n• שינוי תשלום → עדכון סטטוס התשלום באירוע ושליחת הודעת אישור ללקוח.\n\n**אוטומציות מתוזמנות (יומיות):**\n• תזכורות תשלום (14 ו-7 ימים לפני האירוע).\n• תזכורת אירוע (יום לפני).\n• הודעת תודה (יום אחרי).\n• בדיקות יומיות — אירועים ללא DJ משובץ, הצעות מחיר שלא טופלו, כשלי שליחה.'
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'בהגדרות → **"סוכן ווצאפ"** תמצאו קישור לחיבור הסוכן החכם. הסוכן מאפשר לכם לעדכן ולקבל תובנות על ה-CRM ישירות דרך ווטסאפ — למשל לשאול כמה לידים חדשים יש, מה סטטוס אירוע מסוים, ועוד.'
      },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '1. אם הלקוח **כבר קיים** במערכת — הפרטים שלו מתעדכנים. אם **לא קיים** — נוצר ליד חדש עם כל הפרטים שמילא.\n2. סטטוס הליד משתנה אוטומטית ל-**"מילא טופס"**.\n3. נשלחת **התראה במייל** לבעל העסק עם סיכום הפרטים שהלקוח מילא.\n4. נוצרת **משימת טיפול בהצעת מחיר** — להכין ולשלוח הצעה על בסיס הפרטים מהטופס.\n5. הלקוח רואה **דף הצלחה** עם אישור קבלת הפנייה.'
      },
    ]
  },
];
